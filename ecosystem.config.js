module.exports = {
  ...
  deploy : {
    production : {
      ...
      'post-deploy' : './scripts/init_service.sh && npm install && pm2 reload ecosystem.config.js --env production'
    },
    development : {
      key  : '~/.ssh/robotagro',
      user : 'root',
      ...
      ssh_options : ["StrictHostKeyChecking=no", "PasswordAuthentication=no"],
      'post-deploy' : './scripts/init_service.sh && npm install && pm2 reload ecosystem.config.js --env development'
    }
  }
};
